...
void setup() {
  ...
  ioex.config(3, TCA9534::Config::OUT); // Sound shutdown pin
  ioex.config(4, TCA9534::Config::OUT);// MUTE pin
  ioex.output(3, TCA9534::Level::L);
  ioex.output(4, TCA9534::Level::H);// Set pins to enable music playback
  ...
  ioex.output(4, TCA9534::Level::L);// Pull the mute control pin low to enable sound
